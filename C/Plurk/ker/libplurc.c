...
int plurk_add(PLURK *ph, const char *content, const char *qualifier, const char *limit_list)
{
	...
	rc = plurk_request(ph, "/API/Timeline/plurkAdd", NOT_SSL, 4,
			"api_key", ph->apikey,
			"content", content,
			"qualifier", qualifier,
            "limited_to", limit_list);
	return rc;
}
...
int plurk_polling_getUnreadCount(PLURK *ph)
{
    ...
    rc = plurk_request(ph, "/API/Polling/getUnreadCount", NOT_SSL, 1,
            "api_key", ph->apikey);
    return rc;
}
...
int plurk_timeline_getPlurk(PLURK *ph, const char *plurk_id)
{
    ...
    rc = plurk_request(ph, "/API/Timeline/getPlurk", NOT_SSL, 2,
            "api_key", ph->apikey,
            "plurk_id", plurk_id);
    return rc;
}
...
int plurk_timeline_getUnreadPlurks(PLURK *ph)
{
    ...
    rc = plurk_request(ph, "/API/Timeline/getUnreadPlurks", NOT_SSL, 1,
            "api_key", ph->apikey);
    return rc;
}
...
int plurk_timeline_plurkDelete(PLURK *ph, const char *plurk_id)
{
    ...
    rc = plurk_request(ph, "/API/Timeline/plurkDelete", NOT_SSL, 2,
            "api_key", ph->apikey,
            "plurk_id", plurk_id);
    return rc;
...
int plurk_timeline_plurkEdit(PLURK *ph, const char *plurk_id, const char *content)
{
    ...
    rc = plurk_request(ph, "/API/Timeline/plurkEdit", NOT_SSL, 3,
            "api_key", ph->apikey,
            "plurk_id", plurk_id,
            "content" , content);
    return rc;
...
int plurk_timeline_mutePlurks(PLURK *ph, const char *ids)
{
    ...
    rc = plurk_request(ph, "/API/Timeline/mutePlurks", NOT_SSL, 2,
            "api_key", ph->apikey,
            "ids", ids);
    return rc;
...
int plurk_timeline_unmutePlurks(PLURK *ph, const char *ids)
{
    ...
    rc = plurk_request(ph, "/API/Timeline/unmutePlurks", NOT_SSL, 2,
            "api_key", ph->apikey,
            "ids", ids);
    return rc;
...
int plurk_timeline_favoritePlurks(PLURK *ph, const char *ids)
{
    ...
    rc = plurk_request(ph, "/API/Timeline/favoritePlurks", NOT_SSL, 2,
            "api_key", ph->apikey,
            "ids", ids);
    return rc;
...
int plurk_timeline_unfavoritePlurks(PLURK *ph, const char *ids)
{
    ...
    rc = plurk_request(ph, "/API/Timeline/unfavoritePlurks", NOT_SSL, 2,
            "api_key", ph->apikey,
            "ids", ids);
    return rc;
...
int plurk_timeline_markAsRead(PLURK *ph, const char *ids)
{
    ...
    rc = plurk_request(ph, "/API/Timeline/markAsRead", NOT_SSL, 2,
            "api_key", ph->apikey,
            "ids", ids);
    return rc;
